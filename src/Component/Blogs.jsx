    ...
    <div className='grid  grid-cols-2  md:grid-cols-3 gap-6 p-6'>
      {
        blogs.map((records, index)=>{
          ...
          <p className='text-[.9rem] p-2 text-gray-600'>{spliceText}...... </p>
            ...
            <img src={records.img}className='w-20 mt-4 mb-2 rounded' />
            <Link to={`/BlogsDetails/${records.id}`}>
                <button className="bg-gray-200 border border-gray-300 mt-3 cursor-pointer hover:text-gray-200 hover:bg-gray-500 transition-all duration-300 rounded p-[.2rem] text-gray-600 text-[.8rem]">Read more</button>
